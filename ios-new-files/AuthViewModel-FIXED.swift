...
class AuthViewModel: ObservableObject {
    ...
    func handleOAuthCallback(url: URL) async {
        ...
        // URL format: http://localhost:8000/auth/google/callback?code=...
        ...
        do {
            ...
            let loginURL = Constants.apiBaseURL.appendingPathComponent("/auth/login")
            ...
            print("📤 Sending code to backend: \(loginURL)")
