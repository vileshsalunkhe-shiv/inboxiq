...
struct EmailListView: View {
    ...
    var filteredEmails: [EmailEntity] {
        print("🔍 EmailListView: Total emails in FetchRequest: \(emails.count)")
        ...
        print("🔍 EmailListView: Filtered emails: \(filtered.count)")
        return filtered
    }
    ...
    var body: some View {
        let _ = print("🔍 EmailListView rendering. Context: \(viewContext)")
        Group {
